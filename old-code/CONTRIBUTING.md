...
https://fastai1.fast.ai/dev/style.html) first. (Note that we don't follow PEP8, but instead follow a coding style designed specifically for numerical and interactive programming.) For help running and building the code, see the [developers guide](https://fastai1.fast.ai/dev/develop.html).
...
- Document something that is currently undocumented. You can find them by looking for the “new methods” section in any doc notebook. Here’s a [search](https://github.com/fastai/fastai1/search?q=%22new+methods%22&unscoped_q=%22new+methods%22) that lists them
...
* Then, ensure the bug was not already reported by searching on GitHub under [Issues](https://github.com/fastai/fastai1/issues).
...
* Ensure that your PR includes [tests](https://fastai1.fast.ai/dev/test.html) that fail without your patch, and pass with it.
* Ensure the PR description clearly describes the problem and solution. Include the relevant issue number if applicable.
* Before submitting, please be sure you abide by our [coding style](https://fastai1.fast.ai/dev/style.html) and [the guide on abbreviations](https://fastai1.fast.ai/dev/abbr.html) and clean-up your code accordingly.
...
* Once your approach has been discussed and confirmed on the forum, you are welcome to push a PR, including a complete description of the new feature and an example of how it's used. Be sure to document your code and read the [doc on code style](https://fastai1.fast.ai/dev/style.html) and [the one on abbreviations](https://fastai1.fast.ai/dev/abbr.html).
* Ensure that your PR includes [tests](https://fastai1.fast.ai/dev/test.html) that exercise not only your feature, but also any other code that might be impacted. Currently we have poor test coverage of existing features, so often you'll need to add tests of existing code. Your help here is much appreciated!

## How to submit notebook PRs?

* If your PR involves jupyter notebooks (`.ipynb`) you must instrument your git to `nbstripout` the notebooks, as explained [here](https://fastai1.fast.ai/dev/develop.html#stripping-out-jupyter-notebooks).
